...
#.. checked up to PR #31872 / gui #852 for fixes
...
TM	g280  gui_urihandler_nophishing-0.20		0db675f8e90
	...
	Triage: Needs review: 30065 sr-gi/2024-05-fdcount
...
m	14641 fundraw_minconf-21+knots				b097763986a	last=55a0b4c0f90 promag/2018-11-fundrawtransaction
	...
	(CHECK-LAST)	last=b510d2c3e32 getaddressinfo_txids-26+k
...
m	18689 rpc_dumptxoutset_hr-21+knots			b79a47abcb6	last=65d0697fe34
	...
	(CHECK-LAST)	last=a0acbce5122 rpc_dumptxoutset_hr-27
...
m	20254 i2p_static-21+knots					24dc32b1e18	last=8b4a3714b91 vasild/i2p_static
	...
	(CHECK-LAST)	last=f9561082743 rpc_setfeerate-26
	(CHECK-LAST)	last=f9561082743 rpc_setfeerate-28+knots
...
m	21359 rpc_fundraw_includeunsafe-0.21+knots	78c5639bd85
	...
	(CHECK-LAST)	last=835d49b30bc gui_backup_formats-23
		...
		FIXME: src/wallet/dump.cpp:DumpWallet closes the wallet! gcp e714434180d
	...
	(CHECK-LAST)	last=4836fec43a1 autoreindex-27
...
# Non-progress functionality:
	...
	(CHECK-LAST)	last=9482300fab7 gui_netwatch-23+knots
		# NOTE: Was #9849
		# NOTE: Includes #25050
	10615 multiwallet_rpc-0.21+knots			bae1509a9d1	last=3aefa80ffc5 multiwallet_rpc-28+knots
	(CHECK-LAST)	last=8ea217e7251 multiwallet_rpc-27+knots
...
# Non-upstreamed functionality:
	...
	-     walletnotify_w_win-0.21+knots			103ea74ed61	last=622b88bd923 walletnotify_w_win-27+knots
	(CHECK-LAST)	last=4c481517859 walletnotify_w_win-22+knots
	(CHECK-LAST)	last=622b88bd923 walletnotify_w_win-26+knots
	...
	(CHECK-LAST)	last=d9191ae38dd restore_blockmaxsize-25
...
m	7533  sendraw_force-21+knots				84c7abed1ab	last=8b4a4f9b2b4 sendraw_force
	...
	(CHECK-LAST)	last=??? sendraw_force-27+knots
		# NOTE: partial re-PR in #20753 by Marco
	11082 rwconf-0.21							901121d0ce9	last=3e6f24bf30b rwconf-27+knots
	(CHECK-LAST)	last=ad7812c9eb7 rwconf-22
	(CHECK-LAST)	last=3e6f24bf30b rwconf-23+knots
	(CHECK-LAST)	last=3e6f24bf30b rwconf-25+knots
	7510  rwconf_gui-0.21						2df27d4a04e	last=11539fbed54 rwconf_gui-28+knots
	(CHECK-LAST)	last=11539fbed54 rwconf_gui-27+knots
	(CHECK-LAST)	last=5465696bf16 rwconf_gui-22
	(CHECK-LAST)	last=11539fbed54 rwconf_gui-23+knots
	(CHECK-LAST)	last=11539fbed54 rwconf_gui-25+knots
...
m	-     mining_priority-0.21+knots			1e33269a0ae	last=a284d6253ff mining_priority
	...
	(CHECK-LAST)	last=? mining_priority-26+knots
		...
		FIXME: fclose check invisibly merged in 78f55efac9b
...
# POLICY:
	...
	9749  unique_spk_mempool-0.21+knots			52cb2331dee	last=2e3a780f5a7 unique_spk_mempool-28+knots
	(CHECK-LAST)	last=2e3a780f5a7 unique_spk_mempool-27+knots
	...
	-     rwconf_policy-0.21+knots				1d0a8a7bf36	last=6a06b3f2b3b rwconf_policy-28+knots
...
# Pre-BRANDING: (might need to be part of F patch to eliminate binary files)
	...
	7483  svg_icon-21.2+knots					10090268130	last=09bbed8ab16 svg_icon-28+knots
	(CHECK-LAST)	last=75796f01b75 svg_icon-27+knots
...
# BRANDING:
	...
	n/a   knots_branding-21						9db64a56d30	last=16035761f8b knots_branding-28
	(CHECK-LAST)	last=16035761f8b knots_branding-27
	(CHECK-LAST)	last=282420dea44 knots_branding-22
	(CHECK-LAST)	last=16035761f8b knots_branding-25
