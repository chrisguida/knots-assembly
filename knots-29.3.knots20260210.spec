...
# SYSLIBS:
	...
	5416  sys_libsecp256k1						9b95c0fc8b5	last=0a4a73bb830 sys_libsecp256k1-30
	# TODO: sys_crc32c ??
...
# TESTS:
	...
	-     lint_relaxer-29+knots					244ad8c839e
	-     nowarn_unreachable-code				5c2e674d3db
...
# FIXES:
	...
	32217 fix_gitdir_foreign					53e739e353a
		# Was part of #18902
	#30.xTODO# Revert #32220 (cmake: Get rid of undocumented BITCOIN_GENBUILD_NO_GIT environment variable)
	-     relsrc_embed_tagname-29+knots			9eca50035ab	last=607a4fddf61 relsrc_embed_tagname-30+knots
		# Was part of #18902
	18427 2020mingwthrd-mini					203a8592b42	 # Latest code now
	18490 bugfix_symcheck_pe_case				7f2a74f6d77	last=63b637b3c34 bugfix_symcheck_pe_case-30
	14968 http_bind_error						f4b1404c4b2	last=7b5e4001f9 laanwj/2018_12_http_bind_error
	-     http_bind_error+extra					fdcfd282e26	last=33dcd1b043b http_bind_error+extra-30
	 ...
	 9524  rpc_pruneblkchain0					c0f48dabdf1	last=88883ae13d
	10731 log_more_uacomment					dd6b331c3b2
	29614 bufferedfile_fclose					60d6d6ebe6f
	14485 fadvise-29+knots						49c14220ca8	last=8fe39e158f9 fadvise-30+knots
		# Was #12491
	# Needs review: 21313 fsync_dir_pt2 after PR submitted & reviewed & tested
	# Needs bugfix: -     fsync_dir_win
	-     rpcarg_type_per_name					3a7d69ececb
	-     fix_rpc_arg_multiname					0ddd05bfc20
	-     bugfix_rpc_getbalance_hacky			4765c3509c2	last=d5ac1a2b0b1 bugfix_rpc_getbalance_hacky-30
	# FIX THE BELOW:
	...
	18194 bugfix_gui_edit_sendaddr-mini			35692740d7c	last=0a44e08992f bugfix_gui_edit_sendaddr
		# NOTE: -mini is just missing the last commit :)
	# Needs re-concept: 19358 # net: Make sure we do not override proxy settings in hidden service.
	19419 listwalletdir_skip_data				72555a4baa0	last=3f9cc0cd736 Saibato/wallet_351
	...
	g152  gui_notify_setup_bg					470511927dc
	-     bugfix_gui_drop_abc_confusing_hack	d49cd1b2202
	...
	g236  gui_init_walleterror_cont				35c0e0455d7
	-     rpc_addconnection_mainnet				8ae35db1b62
	32343 subproc_closefds						54b325e3fed
		# Was #30756
		# Replaces #22417 (Boost::Process variant)
	# Needs review: 22665 darosior:rbf_optin_nomempool
	23027 bugfix_util_test_config				c506b0f2789
	...
	g506  qt_qrcode_sizefixes					d29287f5012
	# Needs review: 24034 -  # p2p: delete anchors.dat after trying to connect to that peers
	24066 -										93b88572d37	last=89cb2b6d91e  # contrib/init: (OpenRC) use -daemonwait to wait for startup completion
	-     openrc_from_gentoo					f30915cc93b
	...
	24479 bugfix_settings_numberval				54a3f2fb94e
	...
	24718 fix_rpc_docs_pr24718-28+knots			3188f4435ca	last=68a041dd12b
	...
	g595  qt_handle_autostart_errors-0.15		756e8c480ef	last=d932157eb79
		# Upstream mruddy-g/issue_24953 repo got deleted :/
	-   gui_psbt_error_msgbox					939e0ff5daf	last=87c42be2d70 gui_psbt_error_msgbox-30
	...
	32358 fix_subprocess_pr32358-28				de122a9531e
	32567 fix_subprocess_pr32567-28				2491b4c51c7	last=e63a7034f03 hebasto/250520-subprocess-backports
	29868 hww_windows-29						d5990dbd276	last=3a18075aedd hebasto/240414-win-subprocess
	...
	g633  -										f1cdaf38030	last=5fde8fbe085  # qt: Fix shortcut ambiguities
	# Meh: 25854 -  # tracing.md trivial English fixes
	g662  qt_fix_txview_202209					ae8dc0eea29	last=7304c97b1af qt_fix_txview_202209-30
		# Includes gui#368
	...
	g677 fix_qt_peers_na						dd78f204338
	...
	g684  qt_reqs_multiselect_pr684-28+knots	faa59bf5ffe	last=a6f567590b7
	...
	-     qafix_assert_debug_log_create			9f4cc08d45b
	-     acceptstalefeeestimates_mainnet_opt	c8d2e42e780
	...
	27814 forbid_nohelp-29						c2be049ebe4	last=bfc2bb6a270
	...
	28029 fix_zmq_errhandling_202307-mini		cee58765f7a	last=ba28af94bd5 fix_zmq_errhandling_202307
		# Just diff-minimised
	28055 fix_getblockfrompeer_rereq_err		5677b4689dc
	...
	28345 fix_bytespersigop_checks-mini			edcfdecd384	last=6f627727739 fix_bytespersigop_checks
	...
	28616 Sjors/2023/10/assume-unconfirmed		56d8f60cfe1	last=3e281590c7d  # assumeutxo_unconfirmed_ux_Sjors-28
	(CHECK-LAST)	last=202163a6778 assumeutxo_unconfirmed_ux_Sjors-30
	-     assumeutxo_unconfirmed_ux-29			93740ca1345	last=ee1bfd9dada assumeutxo_unconfirmed_ux-30
	-     qt_recomm_confirms-0.9				c632c282d17
	...
	-     fix_keep_notmy_cookie					04ecc890fed	last=61678a031e1 fix_keep_notmy_cookie-30
	...
	28944 rpc_sendall_anti_fee_sniping-28		f57fd67b704	last=aac0b6dd79b ishaanam/sendall_anti_fee_sniping
	-     rpc_walletcfpsbt_antifeesniping-28+k	e568517d011	last=6fc07948bdd rpc_walletcfpsbt_antifeesniping-30+k
	(CHECK-LAST)	last=113ba106273 Sjors/2025/07/locktime
		# Includes tests from #32892
	29141 fix_rpcauth_blank						cdb1057ab32
	...
	29175 -										5c38dbc1807	last=be8ae64b82e  # rpc: validate fee estimation mode case insensitive (fix_rpc_estmode_unset_case-24)
	...
	31551 bulk_block_rw-29+knots				21f2f806c5b
		# Optimisation, not fix - but simplifies #29307
	29307 AutoFile_error_check-29+knots			48994300e16	last=c10e382d2a3 vasild/AutoFile_error_check
	...
	-     fix_rpc_warnings_all-28				b2105b21553
	g815  fix_qt_privacy_before_open-23			559ece76345	last=0dc337f73d0
	...
	-     jonatack/2024-05-fix-cjdns-detection-in-AddNode	054da6f2a2e	last=be4541abe59 jonatack/2024-05-fix-cjdns-detection-in-AddNode  # fix_cjdns_addnode_detect2-27+knots
	...
	-     detect_clang_bug96267					9814e778b61	last=ea6ae8d271e detect_clang_bug96267-30
	...
	31275 fix_rpc_example_quoting_pr31275-24	6d4b7fb22ba	last=7e93e292598
	...
	31514 fix_wallet_rpc_ranged_pr31514-29		edeb967bd43
	...
	31727 miniscript_nonfatal_pr31727-29		b82b638ceab	last=3693e4d6ee0 !hodlinator/2025/04/31727_followup
	...
	31785 fix_gui_rpcconsole_waitfor-29			95135694b0f
	...
	31958 -										55c06390907	last=32dcec269bf  # rpc: add cli examples, update docs  # docfix_rpc_wallet_cf_psbt-24
	31979 -										1eaf1552d01	last=f708498293c  # torcontrol: Limit reconnect timeout to max seconds and log delay in whole seconds  # tor_backoff_max-26
	# Needs review: 32051 jonatack/2025-03-addnode-p2p
	32073 netinactive_dont_downgrade-26			62861c932f4
	...
	32176 tor_rnd_stream_isolation-28			e067bca27f9
		# Omitted renaming variable
	# Needs review: 32180 mzumsande/202403_ibd_lastcommonblock
	32185 fix_dbwrapper_batch_header_size-26	61284b9270c
...
m	32355 fix_block_full_enough-29.3			33b8c314bff
	...
	32414 fix_reidxcs_periodic-25				9d54e875b85	last=c1e554d3e58 andrewtoth/reindex-flush
		# Fix only
	...
	32539 fix_rpcallowip_cjdns-29				e282d4a2a0a	last=12ff4be9c72 pinheadmz/rpcallowip-rfc4193
	...
	32845 fix_rpc_nowallet_errors_pr32845-29	7ec2639acbf
	# Needs concept & review: 32869 instagibbs/2025-07-invalid-cb-stall
	32878 fix_index_rewind_badassert_pr32878-19	793e970edf4
...
TM	33050 cve2025_46598_pt3-29.1                            508b4977497
	...
	g886  wrkrnd_qt_textedit_oom-0.14			c5851a4a7b3
...
NM	33475 fix_block_full_enough_underflow-29+k	dc8ce7dbd47	last=b807dfcdc59 ismaelsadeeq/09-2025-miner-infinite-loop-fix
	...
	-     qt_dialogs_less_modal					3f3ecfee145
	-     docfix_getorphantxs_vsize				eb6d433c484
		# Originally bundled in Knots with #30793 rpc_getorphantxs
	-     fix_guix_boost_mirror-29				8357376ca72
	-     fix_qt_startup_unknown_unit			b03ddff47fb
	-     fix_qt_psbtops_filename_amount		b850891fa9b
	k126  fix_qt_progressbar_fittext			9082511919f
	k150  fix_rpc_mixed_params_edgecases		b11cd619fe7
	...
	-     qt_nowalletpage_alerts-23				fa011618e73
...
# PERFORMANCE:
	...
	28430 -										ceee41aca1e	last=42b25bbd939  # opti_merkle_mutation-0.17
	28592 -										3b22b82b0aa last=b81f37031c8  # txrelayrate_14txps-26
...
m	29602 opti_IsSpace_pr29602-29+knots			0ab27fc79b8
	...
	30611 chainstate_write_hourly-29+knots		8fd07ea0790	last=e976bd30450 andrewtoth/write-chainstate-every-hour
	...
	31144 opti_multibyte_xor-29+knots			08b91789a86
	31179 -										e1197eaa522	last=5d82d92aff7  # opti_rpc_uv_reserve-25
	31645 opti_dbbatchsize_64-29				3a3e1aff7f0	last=b6f8c48946c l0rinc/l0rinc/utxo-dump-batching
	...
	32279 opti_script_inline_36b-29				818acc0c506	last=d5104cfbaeb l0rinc/l0rinc/prevector-size
	32487 opti_readblock_hash_once-29			07ad8032abb
	-     netproc_check_blockhash				4664ada8ca7
	...
	32827 opti_removeForBlock_empty-28			30b183a69c5	last=249889bee6b l0rinc/l0rinc/empty-mempool-IBD
...
# FUNCTIONALITY:
	...
	18479 rpc_sign_show_fees					a9f438e512e	last=47b2ba29df2 !origin-pull/12911/head
	...
	15836 fee_histogram+pr15836_api				7ceabc3c94b	last=b94292a7cb jonasschnelli/2019/04/feeinfo
	...
	22693 getaddressinfo_txids					6e3dfd1f009
	g562  wallet_warn_reuse_gui					7d1434239d5
		# NOTE: Was #15987
	...
	18972 neutrino_whitelist-mini				9604016be93	last=a0d0807abc2 neutrino_whitelist
		# NOTE: Diff-minimised
	# Needs work/review AND CONCEPT ACK: 17950 emilengler:2020-01-password-strength-checker
	-     qt_openuri_pastebtn_shortcut-23		00da773c2ee
	...
	18014 siphash_optimise_pr18014-27+knots		34c154ba801	last=409c2e34522 elichai/2020-01-siphash
	...
	24202 rpc_dumptxoutset_hr-29+knots			835a8242f33	last=1053636ddd9
	...
	19873 mempressure-29+knots					1e55dc10bc3	last=5b43cc77824 mempressure
	...
	g291  gui_trafficgraph_vert-0.21			a731380a4fa	last=500841e49d6  # Enlarge Network Traffic Graph
		# WAS gui#90
	...
	20391 rpc_setfeerate-28+knots				4808cfe31a2	last=1002e2d0d7f jonatack/setfeerate
	...
	20407 rpcauthfile-29+knots					c12a2f5f1a5	last=ff5d7fa1e4c promag/2020-11-rpcauthfile
	...
	g149  intro_assumevalid						98abafa1e69	last=cf940f0e5f5
		# NOTE: Added compatibility for older Qt versions
	# Needs review: 20652 -  # Designer fees when coin control is enabled
	20702 rpc_getblocklocations					fb8d91a096a	last=9b03c654eb3
	...
	g363  qt_peers_directionarrow-25+knots		f7072400cfc	last=727a2f83cca qt_peers_directionarrow
	...
	21928 rpc_hww_toggle-25						de37d287807	last=1af20831806 Sjors/2021/05/hww-toggle
	...
	# TODO: 21283 achow101/psbt2
		# TODO: diff-minimise??
	21260 rpcwallet_tx_in_mempool-29+knots		b5aa8fee2d4	last=46bf0b7b5d8
	...
	22072 autoreindex-29+knots					182bd005746	last=602f4da9178
	...
	g307  gui_peers_rowcolouropt				1f3799829fa	last=fdf80937d1c hebasto-g/210501-stripes
	...
	22372 multinotify							3f7faf97895
	24963 rpc_walletprocesspsbt_options-26		bea17694138	last=40143bafb52 rpc_walletprocesspsbt_options
	...
	-     rpc_descriptorprocesspsbt_opts		137d726e31d
	...
	23362 importfromcoldcard					65dcd6e6e42	last=8076f8d4c2a hebasto/211025-cc
...
m	23387 rpc_savefeeestimates-29+knots			0fad991f3de	last=d5b41e6b2ed greenaddress/dump_fee_estimates  # savefeeestimates
	...
	g473  rebroad-g/NonLinearTraffic			9c5b93928e3	last=ad431ff5d18
		# TODO? change to logarithmic scale? 8398d247f4e
	# Needs work: g484 rebroad-g/RetainNetworkGraphOnIntervalChange
	g492  qt_traffic_tooltip					2b033c8b5e1	last=6c139ebf710 rebroad-g/NetworkGraphTooltip
	...
	g820  qt_fontsel_qrcodes-27+knots			1fb420a7246	last=b14c9d0572e qt_fontsel_qrcodes
	# TODO: qt_fontsel_console
	# Needs review: 24007 -  # [mempool] allow tx replacement by smaller witness
	-     verifymsg_bip137_and_electrum			2c48856d180
		# NOTE: Fully reverts gui#819 in anticipation of #24058
	24058 bip322-29+knots						de836e92d26	last=29b28d07fa9 kallewoof/202201-bip322
	...
	24162 rpc_deriveaddr_wo_checksum-29			7d8a0fc9b34	last=97a69e232be
		# +RPC doc fix
	...
	25183 rpc_fundraw_segwitonly				5ce3f46d62f	last=9e7fd5c0fe3
	...
	-     whitelist_outgoing_auto				2cd4cdfdc57
	# Needs work: 26441 brunoerg/2022-10-whitelist-rpc
		# CAUTION: neutrino whitelisting interaction
	27446 benthecarman/configure-signet-blockitme	05284952a0e	last=d8434da3c14
	...
	26576 rpc_disconnectnode_subnet				21678297628	last=23f4c2cb452 brunoerg/2022-11-disconnectnode-subnet
	...
	27034 rpc_importaddr_for_descwallet-27+k	68a7b065245	last=be3ae51ece8 furszy/2022_rpc_importaddress_descriptors_compatible
		# Diff-minimised & tweaked to avoid breaking #23362
	27052 rpc_getpeerinfo_lastblockann-28		558af0e33de	last=cbe4603a902 LarryRuane/2023-02-getpeerinfo
		# Avoided changing internal data structures
	27216 rpc_getaddressinfo_isactive			1f595771004	last=85f83339dda pinheadmz/used-addr-ui
	# Needs work: 27260 -  # Enhanced error messages for invalid network prefix during address parsing.
	27351 codex32-29+knots						0af4c924334	last=91771366a3d apoelstra/2023-03--codex32
	...
	27600 p2p_forceinbound-28+knots				0dd769b06e2	last=8c2026848da pinheadmz/whitebind-evict
	...
	27770 rpc_getblockfileinfo-28+knots			2c99f527a38	last=5090771f326 furszy/2023_rpc_getblockfileinfo
	...
	29016 rpc_listmempooltxs-29+knots			72d0d577fc1	last=07008477b81 niftynei/nifty/listmempoolentry
	...
	# Needs review/optional? 30572 ariard/reject-unsolicited-txn
		# Was #21224
	#29.xTODO# 30595 + 33791 + 33796 + 33822 + 33825 + 34401  libbitcoinkernel C API
	30635 rpc_waitfornewblock_tip_param-29+k	87f2c470fac	last=c6e2c31c551 Sjors/2024/08/waitforblock
	# Needs review: 30685 hebasto/240820-control-flow
	30713 -										33e5e966f08	last=5b2d0216d87  # rpc_scanblocks_status_results-28
	...
	30860 bashcomp_bcli_generate-29				a3a92bd38fb	last=abf6ad42bdb BrandonOdiwuor/bash-completion
		# Bugfix + Left off re-generation until later
	k190  feat_zsh_completion-29				b902d85200b	last=e3f6d308a97  # Add zsh completion script generation support
	# Needs work: k199 mstampfer/cmake-zsh-completion-only
	30886 rpc_descrprocesspsbt_prevtxs-28+knots	0a6133e4e3b	last=87ceb610a72 instagibbs/2024-09-updateutxo_psbt
	...
	31845 pruneduringinit-29+knots				b156033a735	last=d4a3abf6d43 pruneduringinit
	31886 netinfo_local_svcs-29+knots			25d5e3050bc	last=721a051320f jonatack/2025-02-netinfo-services
	# Needs work: 31936 -  # rpc: Support v3 raw transactions creation
	31953 bumpfee_full_rbf-29+knots				4b4a8643570	last=fa86190e6ed maflcko/2502-fullrbf-follow-up
		# Was: 26454 petertodd/2022-feebump-without-optin
		# NOTE: Added warning to GUI and made RPC behaviour change optional
	32200 socks_tor_error_codes-0.18			8d58af700d4
	# Needs work? 32297 ryanofsky/pr/ipc-cli
	32423 hash_rpcuserpass-29+knots				0bff62dc1cb	last=e49a7274a21 laanwj/2025-05-remove-rpcpassword-deprecation
		# Left out refactoring
	32425 proxy_per_net-29						ad140391ecc	last=e98c51fcce9 vasild/proxy_per_network
		# Left out doc updates/reformatting
	32429 doc_rpc_keypoolrefill_pr32429-23		bcb895a48c9
	...
	32540 rest_spenttxouts-26					906d98f1e31
		# +32842
	...
	33230 rpc_cli_hashorheight-29				c4545db234d	last=df67bb6fd84 achow101/cli-strong-or-json
...
# Non-progress functionality:
	8751  sort-multisigs-28+knots				577fcb49221	last=e11cb50a09  # multisig sorting
		# held back 50e2ff58f2..e11cb50a09 which turned options into a boolean directly
	22016 rpc_gbci_period_start					999cfaca90c	last=1898b9be12c Sjors/2021/05/versionbits_period_start
	9152 sweepprivkeys-29+knots					0263406c21b
...
m	9245 ionice-29+knots						1bcbcb27a6f
	...
	8501  old_stats_rpc-29						33cb8d29aad	last=7af0ea43b2
		# Many fixes (incl knots#226)
		# Held back on old version due to conflict with GUI updates...
	8550  old_stats_qt-29+knots					75b9fe21aed	last=63fb11652f
		# Held back on old version due to conflict with RPC updates...
	9504  rpc_dumpmasterprivkey					ca8a492c1f3	last=07fc81109a
...
m	10615 multiwallet_rpc-29+knots				8ce7f6318be  # latest code now
	...
	10350 filtered_witblock-28				205fe0fbf58	last=3f388ddcd3 CodeShark/MFWB_no_bump_2
	...
	11750 coincontrol_multiselect				d73e73c0fde	last=7cec76f81b # Multiselect in coincontrol treewidget and display selected count
		# NOTE: deviated from PR
	11770 rest_fee								8c102fcd45e	last=eff1b3e201  # [REST] add a rest endpoint for estimatesmartfee, docs, and test
	...
	11803 bugfix_dumpwallet_hdkeypath			0bb070e498a
	12965 scriptthreads-29+knots				18a6161894f	last=dfab6c6866 jonasschnelli/2018/04/svt
	13203 dsha256_power8-29						373c3039e5d	last=3b402e0738 TheBlueMatt/2018-05-asm
...
m	15421 tor_subprocess-29+knots				7f1d89276e4	# Latest code now
	...
	17795 gui_console_ctrl_d-26+knots			041d67603ec
		# NOTE: Completely rewrote to work on all platforms, in addition to Ctrl-W
	15861 restore_vbits_warning					4bf790fb281
	n/a   rpc_compat_error_index-25+knots		23f475b4e6a
		# Compatibility with 0.19.0-0.21.0 bech32_error_detection
	g537  gui_bech32_errpos						42ae2975e3f
	17636 guisettings-0.21						8f0d981456e	last=187f9684e03 emilengler/2019-11-guisettings
		# Held back 5266efa964b..187f9684e03 (too strict error checking?)
		# (and removed release notes)
	17958 rpc_getgeneralinfo					9ed463c10d4	last=cdbd38df131  # getgeneralinfo RPC
	18223 blockfilter_v0						bd75b36b31b	last=5561e7a0c79
		# NOTE: Don't enable with -blockfilterindex=1
		# NOTE: Diff-minimised
	19089 cli_getinfo_mwbalances-29				706c1ebf02d	last=865d2c32d5a jonatack/cli-getinfo-multiwallet-follow-ups
	19092 cli_getinfo_mw_total_balance-29+knots	68655c1338e	last=08ac1abc583 jonatack/cli-getinfo-multiwallet-total-balance
	(CHECK-LAST)	last=71bfa1fb715 cli_getinfo_mw_total_balance-26
	19117 rpc_getrpcwhitelist					f4df3b64059
		# NOTE: Was #18827 before any Knots merge
	-     getrpcwhitelist_wallets-29+knots		9c8860290f3
		# NOTE: when #19118..#19120 get merged, add 71294ee9799
	# Needs purpose: 21815 prayank23:max-out-full-relay
	-     wallettool_dump_warning-29+knots		f8c2f9d00f0
...
m	30951 v2onlyclearnet-29+knots				76ae62fffed	last=6b2796a7f76
	...
	-     font_for_money_global					1e3afd62774
	k157  qt_darkmode-29+knots					f1fa764cf07	last=2c15a2071f6 bigshiny90/v29.1-knots-rc1-guifixes
...
m	-     restore_upnp-29.2+knots				42ee4c0c8d1
	...
	-     rpc_mempoolentry_txhash				ffc3c230d84
	...
	7107  qtnetworkport-29.1+knots				0d21cbca4da	last=1f37c87d8f2 origin-pull/7107/head
		# FIXME: Unbind IPv6 on the other port, if its IPv4 bind failed
	7533  sendraw_force-29.2+knots				3ae7d4991df last=2627c0937f8 sendraw_force
...
m	11082 rwconf-29+knots						7bfaa3be4a3 # Latest code now
	...
	559   accept_nonstdtxn						fe7652bce39
		#30.xTODO# Revert or redefine #29843 if it got merged
	929   tbc									de39bf8ee4e
	n/a   tbc_font								9e98c4b25c8
		# Includes ff7b90dc729 Embedded font: Rename to avoid confusion in font selector  (fix_qt_fontsel_confusion)
	 553 bugfix_qt_uri_amount_parser			382a7b97938
	5861 gui_restore_addresses					a6b1a0a4a68
	5891  qt_console_history_persist			6cd5f415b81	last=2e1d9cb3466 qt_console_history_persist
	...
	-     net_identify_librerelay				4e8bbfc3bf8
	-     net_identify_utreexo					11ce7f27836
	# TODO? petertodd has a branch with 4 extra outgoing peers requiring RBF service flag
	# TODO: some way to add UA comments via rwconf
	12146 opt_wallet_segwit2					f670a817871
	...
	-     gui_wallet_displayname_wo_dat			f55f6830e73	# Latest code now
	-     gui_request_payment_label-0.19		4c22254b71d
	-     gui_peers_sort_network-23				5605cb72874
	-     gui_peers_no_net_column				4994fb1954c
	...
	-     rpc_getblockfrompeer_future			03b680f8fc7
		# Revert of #23927
	-     rpc_getblockfrompeer_wo_header		d5f99d18eac
	...
	32547 mining_avoid_block_copy-29+knots		02ce722249c	last=7d05ec01d4e mining_avoid_block_copy
	-     gbt_rpc_options-29+knots				9c931d8eabb
	...
	-     blockview-29+knots					e058d6e28e1
	...
	-     restore_libconsensus					ca4cb7f97e7
	...
	-     rpccookieperms_log_improvements-29+k	d2e1d36e78c
	...
	33023 qa_cb_extratxs-25						38a923eca7c	last=841b3c2e966 bigshiny90/compactblocks-extratxs-tests-core
		# Held back f9c6331cb26...841b3c2e966 for now
	#30.xTODO# Revert #32450 ?
	#30.xTODO# Revert #32510 or replace extratxn pool
	k171  Raimo33/add-dockerfile				ffc19929567	last=4b778a21835
	k187  Retropex/dnsseed-leo					acb5072a560	last=68abc8a3262
...
# Non-upstreamed policy options (default off):
	...
	7219  rbf_opts-29+knots						3779f681faa	# Latest code now
	-     truc_opts-29.2+knots					3c1362427f0
	#TODO/Needs work: 10823 greenaddress/replace-by-fee-old-transactions
	29309 permitbarepubkey-29+knots				ccdced83793	last=1dfe27e49ab
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
	-     bytespersigopstrict-29+knots			57318e50f50
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
	9749  unique_spk_mempool-29.2+knots			e1941c12613
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
	-     dustdynamic-29.1+knots				6725aa027a4
	# ---- BEGIN DATACARRIER ---- (OLGA not backported)
	28408 match_more_datacarrier-29+knots		0a333f42e71	last=4d2ec0671a3 match_more_datacarrier
	...
	-     datacarriercost-29+knots				b3e0660684f
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
		#30.xTODO# Add tests and make sure boundaries are correct
	-     acceptnonstddatacarrier-29+knots		938fd43a942
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
	...
	# ---- END DATACARRIER ----
	k136  pol_permitephemeral					79cb44f8bfc
	...
	-     rejecttokens-29.1+knots				51cff002888
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
		# Currently filters just Runes
	k78   rejectparasites-29.1+knots			b71ad45c6eb	last=d978324923a
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
	...
	-     maxscriptsize-29+knots				f7525aedc45
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
		# Alternate to(?) #29769
	...
	k148  minrelaymaturity-29.1+knots			018cc582cba
	...
	-     pol_maxtxlegacysigops-29.1+knots		4bdc33ee642
		# Made user-configurable and overridable
	-     blockreconstructionextratxnsize		b74eeb082fa
	...
	k162  qt_bad_external_signer_msg-22			9f262dbaba2	last=111c401fc5a bigshiny90/fix-invalid-scriptsigner-errordialog
...
# Non-upstreamed Knots compatibility:
	...
	-     compat_rpc_dumptxoutset_hr			dfa97cc502a
		# FIXME: 'type' param attempts to parse as JSON ? (with 28.x bitcoin-cli tho)
		# FIXME: 'rollback' param rejects height ?
	-     compat_jsonrpc_weirdversions			03cba795152
	29530 rpc_getpeerinfo_misbehaving_score-29+k	4a0ca4d7420	last=87efb6f0cfd
	...
	-     rpccookieperms_octal_compat-29+knots	6d40ed6e158
	-     zmq_ipc_uri_compat					81a02554e0b	last=0b1762c90d1 origin-pull/28020/head
	...
	-     wallet_undeprecate_legacy-29			d83ed66061d
	...
	14641 fundraw_min_conf_deprecated-25+knots	ee8601d5a4a	last=55a0b4c0f90 promag/2018-11-fundrawtransaction
	-    preserve_unsupported_keyflags			5dd1174fb90
	-     netperms_implicit_addr				851a3a2e67b
	-     rpc_getblockfrompeer_nodeid_compat	46a0795d316
	# TODO: add a bitcoinknots.conf ?
	n/a   gui_peers_bump_setting_keys-29+k		641bacfc298
...
# POLICY:
	-    1day_default_conftarget				402a623e2ec
	...
	-     def_bloom_local_only					31e9bb12511
		# NOTE: Includes typo fix
	-     wallet_avoid_newerchange				0575aefb3fe
	-     enforce_checkpoints					331c67af540
		#30.xTODO# Revert #31649
	n/a   checkpoint_update-29					9c8e2fc4256
...
#	n/a  knots_historical_relnotes				61100a2
	...
	n/a   (cherrypick=dce09dbcdc4)				f7f99b3464c  # release notes: write/update, including change log and credits
	...
	n/a  (cherrypick=a9aee730466)				7b009f5531b  # update manpages (build first)
