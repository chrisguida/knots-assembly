...
# FIXES:
	...
	-     relsrc_embed_tagname-29+knots			62eb96ecb47	last=607a4fddf61 relsrc_embed_tagname-30+knots
		# Was part of #18902
	18427 2020mingwthrd-mini					814b6b49ce4	 # Latest code now
	18490 bugfix_symcheck_pe_case				03d86b04479	last=63b637b3c34 bugfix_symcheck_pe_case-30
	14968 http_bind_error						cd6c3f56bef	last=7b5e4001f9 laanwj/2018_12_http_bind_error
	-     http_bind_error+extra					4e9c0c3c994	last=33dcd1b043b http_bind_error+extra-30
	...
	14485 fadvise-29+knots						13b390eddfa	last=8fe39e158f9 fadvise-30+knots
		# Was #12491
	...
	-     bugfix_rpc_getbalance_hacky			2630df80b39	last=d5ac1a2b0b1 bugfix_rpc_getbalance_hacky-30
	# FIX THE BELOW:
	...
	19419 listwalletdir_skip_data				8ad3762f857	last=3f9cc0cd736 Saibato/wallet_351
	...
	23027 bugfix_util_test_config				1a035556544
	...
	-   gui_psbt_error_msgbox					72401068235	last=87c42be2d70 gui_psbt_error_msgbox-30
	...
	32358 fix_subprocess_pr32358-28				093d6de9642
	32567 fix_subprocess_pr32567-28				c22c8c9e73d	last=e63a7034f03 hebasto/250520-subprocess-backports
	29868 hww_windows-29						75579a5194c	last=3a18075aedd hebasto/240414-win-subprocess
	...
	g662  qt_fix_txview_202209					de5a1da8feb	last=7304c97b1af qt_fix_txview_202209-30
		# Includes gui#368
	...
	g684  qt_reqs_multiselect_pr684-28+knots	83ffb80caa1	last=a6f567590b7
	...
	28345 fix_bytespersigop_checks-mini			812c03ec467	last=6f627727739 fix_bytespersigop_checks
	...
	28616 Sjors/2023/10/assume-unconfirmed		32f2ca3aed5	last=3e281590c7d  # assumeutxo_unconfirmed_ux_Sjors-28
	(CHECK-LAST)	last=202163a6778 assumeutxo_unconfirmed_ux_Sjors-30
	-     assumeutxo_unconfirmed_ux-29			a4de6ecb351	last=ee1bfd9dada assumeutxo_unconfirmed_ux-30
	...
	-     fix_keep_notmy_cookie					9c1e58ed784	last=61678a031e1 fix_keep_notmy_cookie-30
	...
	28944 rpc_sendall_anti_fee_sniping-28		4e16d687280	last=aac0b6dd79b ishaanam/sendall_anti_fee_sniping
	-     rpc_walletcfpsbt_antifeesniping-28+k	dbb5c6b55f2	last=6fc07948bdd rpc_walletcfpsbt_antifeesniping-30+k
	...
	29175 -										6a9023eadbe	last=be8ae64b82e  # rpc: validate fee estimation mode case insensitive (fix_rpc_estmode_unset_case-24)
	...
	31551 bulk_block_rw-29+knots				9a35fafe14b
		# Optimisation, not fix - but simplifies #29307
	29307 AutoFile_error_check-29+knots			1e492f5ce53	last=c10e382d2a3 vasild/AutoFile_error_check
	...
	-     detect_clang_bug96267					8cefd672dd1	last=ea6ae8d271e detect_clang_bug96267-30
	...
	31275 fix_rpc_example_quoting_pr31275-24	6905fb18e76	last=7e93e292598
	...
	31727 miniscript_nonfatal_pr31727-29		d1de0b7164a	last=3693e4d6ee0 !hodlinator/2025/04/31727_followup
	...
	31785 fix_gui_rpcconsole_waitfor-29			79974469bfc
	...
	31958 -										374b4768f13	last=32dcec269bf  # rpc: add cli examples, update docs  # docfix_rpc_wallet_cf_psbt-24
	31979 -										e8e5fb227cc	last=f708498293c  # torcontrol: Limit reconnect timeout to max seconds and log delay in whole seconds  # tor_backoff_max-26
	# Needs review: 32051 jonatack/2025-03-addnode-p2p
	32073 netinactive_dont_downgrade-26			1739bbd5ecc
	...
	32176 tor_rnd_stream_isolation-28			7af63e8faac
		# Omitted renaming variable
	# Needs review: 32180 mzumsande/202403_ibd_lastcommonblock
	32185 fix_dbwrapper_batch_header_size-26	5833dcd8ffb
	...
	32344 fix_wallet_nonranged_pr32344-22		bd20cd5c0cc	last=97d383af6d5
	32351 qafix_nonrecurs_FindChallenges-28		7eddd7b510e
		# Fix only
	32355 fix_block_full_enough					dc9baf7d33e
	# Needs review: 32367 hebasto/250428-enable-lang
	-     fix_fs_error_utf8-23					0ad28e9aa5d
	...
	32539 fix_rpcallowip_cjdns-29				8508a00ee75	last=12ff4be9c72 pinheadmz/rpcallowip-rfc4193
	...
	32682 fix_wallet_fillpsbt_nothrow-28		2dabe6aabe0
		# Diff-minimised only
	# Needs review: 32685 -  # wallet: Allow read-only database access for info and dump commands
	32736 fix_listwalletdir_err-23				a24225a4735
	...
	32845 fix_rpc_nowallet_errors_pr32845-29	f55774ad13a
	# Needs concept & review: 32869 instagibbs/2025-07-invalid-cb-stall
	32878 fix_index_rewind_badassert_pr32878-19	f0c0c15a6cb
	...
	33311 log_quiet_pcp_unsupported-29			ea7cbe71ef3
	33338 pcp_interrupt-29						61699ea52bc
		# Diff-minimised
	...
	g886  wrkrnd_qt_textedit_oom-0.14			26fa4aaa01f
	...
	33580 fix_depends_fallback_filename-0.13	5299fc8950b	last=671b774d1b5 achow101/depends-fallback-name
	...
	33813 warn_for_rpcbind_ignored-29						last=0cca5b772a9 Ataraxia009/rpc-bind-warning
...
# PERFORMANCE:
	...
	30611 chainstate_write_hourly-29+knots		400da718054	last=e976bd30450 andrewtoth/write-chainstate-every-hour
	...
	32827 opti_removeForBlock_empty-28			daf24dac4d4	last=249889bee6b l0rinc/l0rinc/empty-mempool-IBD
	...
	33332 opti_arith_uint256_trivialcopy-28		6ec473b8a99
	33334 opti_blkidx_comparator-26+knots		f3b0c131368	last=80ac0467ef4 Raimo33/index-work-comparator-branchless
	33410 opti_coinstats_nocopy_pr33410-26		a35ca3225d7	last=5a56203f4e4  # coinstats: avoid unnecessary Coin copy in ApplyHash
...
# FUNCTIONALITY:
	...
	24963 rpc_walletprocesspsbt_options-26		eba45ef365a	last=40143bafb52 rpc_walletprocesspsbt_options
	...
	27034 rpc_importaddr_for_descwallet-27+k	8f24b3dc7a0	last=be3ae51ece8 furszy/2022_rpc_importaddress_descriptors_compatible
	...
	27770 rpc_getblockfileinfo-28+knots			358856361eb	last=5090771f326 furszy/2023_rpc_getblockfileinfo
	...
	30886 rpc_descrprocesspsbt_prevtxs-28+knots	b77212d5ccf	last=87ceb610a72 instagibbs/2024-09-updateutxo_psbt
	...
	31886 netinfo_local_svcs-29+knots			4ec453a3ad9	last=721a051320f jonatack/2025-02-netinfo-services
	# Needs work: 31936 -  # rpc: Support v3 raw transactions creation
	31953 bumpfee_full_rbf-29+knots				787b46e37b6	last=fa86190e6ed maflcko/2502-fullrbf-follow-up
		# Was: 26454 petertodd/2022-feebump-without-optin
		# NOTE: Added warning to GUI and made RPC behaviour change optional
	32200 socks_tor_error_codes-0.18			68586ec5ec4
	# Needs work? 32297 ryanofsky/pr/ipc-cli
	32423 hash_rpcuserpass-29+knots				e4c690fefad	last=e49a7274a21 laanwj/2025-05-remove-rpcpassword-deprecation
		# Left out refactoring
	32425 proxy_per_net-29						632861c8802	last=e98c51fcce9 vasild/proxy_per_network
		# Left out doc updates/reformatting
	32429 doc_rpc_keypoolrefill_pr32429-23		6a1069fb2f5
	...
	32540 rest_spenttxouts-26					4c67c62588d
		# +32842
	...
	32844 rpc_gettxoutproof_segwit-27+knots		cd053f34c8a	last=23edd3db4f1 rpc_gettxoutproof_segwit
	# WIP: 32857 Sjors/2025/07/no_script_path
	# Needs review: 32896 ishaanam/wallet_v3_txs
	33004 def_natpmp_true-29					1114594520a
...
#	n/a  knots_historical_relnotes				61100a2
	...
	n/a   (cherrypick=f7f99b3464c)				8a0a4c31679  # release notes: write/update, including change log and credits
	...
	n/a  (cherrypick=7b009f5531b)				eeb9cc11206  # update manpages (build first)
