...
# PERFORMANCE:
	...
	35197 lld_icf_safe-28						3e8c5fd0510	last=5c6c4260948 fanquake/lld_icf_safe
...
# SOFTFORK:
	k289  rdts_not_enforced_prompt				bdd7995f5ca
	# Disabled: k238 rdts_combined-29+knots								last=f62f5fda667
...
# Pre-BRANDING: (might need to be part of F patch to eliminate binary files)
	n/a   (delete_release_notes_fragments)		8b306660bb3
	# Triage: 34808 hebasto/260311-qt-ts-source
	7483  svg_icon-29.3+knots					56dcf360b10
		# Consider: https://github.com/bitcoinknots/bitcoin/pull/54
# BRANDING:
	n/a   upd_copyrightyear-29					4d75537b426
	n/a   font_ocrbitcoin						8ef49bd20e8
	n/a   knots_branding-29						8b296e30e6c
...
# TODO: test fuzzer with everything enabled
	n/a   (cherrypick=488640fe20b)				3f7a03f1ef4	# doc/{bips,files}
		# TODO: Update with bump_version below !!!!
	n/a  (bump_version=knots20260507)			168c36a2c3b
#	n/a  knots_historical_relnotes				61100a2
	n/a   rm_historical_relnotes_from_dist		07ff5e2bd29
	n/a   (cherrypick=4515e84b318)				4515e84b318  # release notes: write/update, including change log and credits
	...
	n/a  (cherrypick=4bb7c0e8dbd)				4bb7c0e8dbd  # update manpages (build first)
