...
The default target is `v29.3.knots20260210`. Pass any release tag as
a positional argument to `run-all.sh`:
...
After each new dated release ships, re-point `KNOTS_TAG` and
`KNOTS_SPEC` in `.github/workflows/reproduce.yml`. Reproduction of
